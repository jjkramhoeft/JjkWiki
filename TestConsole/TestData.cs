...
public static class TestData
{
  ...
  /// Some random pages
  /// </summary>
 public static List<string> TestPages = 
 [
...
=== Screenings ===
''Actrius'' screened in 2001 at the [[Grauman's Egyptian Theatre]] in an [[American Cinematheque]] retrospective of the works of its director. The film had first screened at the same location in 1998.<ref name=""LA Times"">{{cite news|last1=THomas|first1=Kevin|title=Sometimes, the World Gets in the Way|url=https://www.latimes.com/archives/la-xpm-2001-mar-01-ca-31570-story.html|lang=en|access-date=2015-12-21|newspaper=[[Los Angeles Times]]|date=2001-03-01|archive-url=https://web.archive.org/web/20121221084433/http://articles.latimes.com/2001/mar/01/entertainment/ca-31570|archive-date=2012-12-21|url-status=live}}</ref> It was also shown at the 1997 [[Stockholm International Film Festival]].<ref name=SFF />
...
==Related products==
Julia MacRae Books published an ''Animalia'' [[colouring book]] in 2008.<ref>{{cite web|last=Penguin Books |title=Animalia Colouring Book |url=http://www.penguin.com.au/products/9781405904674/animalia-colouring-book |access-date=8 June 2013 |url-status=dead |archive-url=https://web.archive.org/web/20131002205038/http://www.penguin.com.au/products/9781405904674/animalia-colouring-book |archive-date=2 October 2013 }}</ref> [[Abrams Books|H. N. Abrams]] also published a wall calendar colouring book version for children the same year.<ref>{{cite web|last=LibraryThing.com|title=Animalia 2008 Coloring Calendar|url=http://www.librarything.com/work/6090521|access-date=8 June 2013}}</ref>

H. N. Abrams published ''The Animalia Wall Frieze'', a fold-out over 26 feet in length, in which the author created new riddles for each letter.<ref>{{cite web|last=BookFinder.com|title=The Animalia Wall Frieze|url=http://www.bookfinder.com/dir/i/The_Animalia_Wall_Frieze/0810924757/|access-date=8 June 2013}}</ref>

The Great American Puzzle Factory created a 300-piece jigsaw puzzle based on the book's cover.<ref>{{cite web|publisher=Amazon|title=Animalia 300-piece jigsaw puzzle |url=https://www.amazon.com/Animalia-Graeme-Piece-Jigsaw-Puzzle/sim/B000R2ZUCE/2|access-date=8 June 2013}}</ref>

==Adaptations==
A [[Animalia (TV series)|television series]] was also created, based on the book, which airs in [[Canada]]. [[Australian Children's Television Foundation|The Australian Children's Television Foundation]] released a teaching resource DVD-ROM in 2011 to accompany the TV series with teaching aids for classroom use.<ref>{{cite web|last=Curriculum Press |title=Animalia – Primary teaching resource |url=http://www.curriculumpress.edu.au/main/goproduct/13167 |access-date=7 June 2013 |url-status=dead |archive-url=https://web.archive.org/web/20130503092444/http://www.curriculumpress.edu.au/main/goproduct/13167 |archive-date=3 May 2013 }}</ref>

In 2010, The Base Factory and AppBooks released Animalia as an application for [[iPad]] and [[iPhone]]/[[iPod Touch]].<ref>
{{cite web|last=MyBookCorner.com.au|title=Animalia – Anniversary Edition|url=http://www.mybookcorner.com.au/apps/611-animalia-anniversary-edition|access-date=7 June 2013|archive-url=https://web.archive.org/web/20140127002235/http://www.mybookcorner.com.au/apps/611-animalia-anniversary-edition|archive-date=27 January 2014|url-status=dead}}
</ref>

==Awards==
''Animalia'' won the Young Australian's Best Book Award in 1987 for Best Picture Story Book.<ref>{{cite web|last=Yabba.org|title=Award Winners – 1986 through 2011|url=http://yabba.org.au/award-winners-1986-through-2011/|access-date=8 June 2013}}</ref>

The [[Children's Book Council of Australia]] designated ''Animalia'' a 1987 [[Children's Book of the Year Award: Picture Book|Picture Book of the Year]]: Honour Book.<ref>{{cite web|last=The Children's Book Council of Australia |title=Winners and Commended Books 1980 – 1989 |url=http://cbca.org.au/8089.htm |access-date=8 June 2013 |url-status=dead |archive-url=https://web.archive.org/web/20141216043453/http://cbca.org.au/8089.htm |archive-date=16 December 2014 }}</ref>

Kid's Own Australian Literature Awards named ''Animalia'' the 1988 Picture Book Winner.<ref>{{cite web|last=KOALA New South Wales |title=Complete list of KOALA winners 1987 to 2012 |url=http://www.koalansw.org.au/storage/Complete%20list%20winners%201987%20to%202012.pdf |access-date=8 June 2013 |url-status=dead |archive-url=https://web.archive.org/web/20130409162703/http://www.koalansw.org.au/storage/Complete%20list%20winners%201987%20to%202012.pdf |archive-date=9 April 2013}}</ref>
...
* [http://graemebase.com.au/ Graeme Base's official website]
...
| Representative = 6 Republicans{{break}}1 [[Democratic Party (United States)|Democrat]]
...
Alabama, along with [[Oklahoma]] and [[Iowa]], has the most confirmed [[Fujita scale|F5]] and [[Enhanced Fujita scale|EF5]] tornadoes of any state, according to statistics from the [[National Climatic Data Center]] for the period January 1, 1950, to June 2013.<ref>{{cite web |title=LIST: States with the most F5/EF5 tornadoes since 1950; Ohio high on list |url=http://www.newsnet5.com/weather/weather-news/kshb-list-states-with-the-most-ef5-tornadoes |access-date=April 26, 2014 |archive-url=https://web.archive.org/web/20140426232719/http://www.newsnet5.com/weather/weather-news/kshb-list-states-with-the-most-ef5-tornadoes |archive-date=April 26, 2014}}</ref> Several long-tracked F5/EF5 tornadoes have contributed to Alabama reporting more tornado fatalities since 1950 than any other state. The state was affected by the [[1974 Super Outbreak]] and was devastated tremendously by the 2011 Super Outbreak. The 2011 Super Outbreak produced a record amount of tornadoes in the state. The tally reached 62.<ref>{{cite web |last=Oliver |first=Mike |title=April 27's record tally: 62 tornadoes in Alabama |date=August 4, 2011 |url=http://blog.al.com/spotnews/2011/08/april_27s_record_tally_62_torn.html |publisher=al.com |access-date=November 4, 2012 |archive-date=November 9, 2012 |archive-url=https://web.archive.org/web/20121109185256/http://blog.al.com/spotnews/2011/08/april_27s_record_tally_62_torn.html |url-status=live}}</ref>
...
The 2023 ''American Values Atlas'' by [[Public Religion Research Institute]] found that a majority of Alabama residents support [[Same-sex marriage in the United States|same-sex marriage]].<ref>{{Cite web |last=Staff |date=February 24, 2023 |title=American Values Atlas: Approval of Same-Sex Marriage in Alabama |url=https://ava.prri.org/#lgbt/2022/States/lgbt_ssm/m/US-AL |access-date=April 12, 2023 |website=[[Public Religion Research Institute]] |archive-date=April 4, 2017 |archive-url=https://web.archive.org/web/20170404161714/https://ava.prri.org/#lgbt/2022/States/lgbt_ssm/m/US-AL |url-status=live}}</ref>
...
==== Federal elections ====
The state's two [[United States Senate|U.S. senators]] are [[Katie Britt]] and [[Tommy Tuberville]], both of whom are Republican. In the [[United States House of Representatives|U.S. House of Representatives]], the state is represented by seven members, six of whom are Republicans ([[Jerry Carl]], [[Mike Rogers (Alabama politician)|Mike Rogers]], [[Robert Aderholt]], [[Dale Strong]], [[Barry Moore (American politician)|Barry Moore]], and [[Gary Palmer (politician)|Gary Palmer]]) and one Democrat [[Terri Sewell]], who represents the Black Belt as well as most of the predominantly black portions of Birmingham, Tuscaloosa and Montgomery.
...
[[File:William J. Samford Hall.jpg|thumb|right|William J. Samford Hall at [[Auburn University]]]]
...
* [http://www.ers.usda.gov/data-products/state-fact-sheets/state-data.aspx?StateFIPS=01&StateName=Alabama Alabama State Fact Sheet] from [[Economic Research Service]], [[U.S. Department of Agriculture]]
* {{OSM relation|161950}}
...
[[Category:Alabama| ]]<!--please leave the empty space-->
